 ...
 * @remarks No signing, RPC transports, background workers, or Node-only runtime are exported.
 * Callers own account freshness, validation, fee selection, transaction assembly and submission.
 */
