...
export const TOKEN_PROGRAM_2022 = new PublicKey(
  "TokenzQdBNbLqP5VEhdkAS6EPFLC1PHnBqCXEpPxuEb",
);

// Token mints
export const SOL_TOKEN_ACCOUNT = new PublicKey(
...
export const BONK_PROGRAM = new PublicKey(
...
export const SDK_FEE_RECIPIENT = new PublicKey(
